...
# ── Sysroot ───────────────────────────────────────────────────────────────────
# Assumes you rsynced RPi-2's /lib and /usr into ../root/ relative to ClusterUI/
# i.e. your layout:
#   rpi5/
#     ClusterUI/         <- this file lives here
#     root/              <- sysroot
#       lib -> usr/lib
#       usr/
get_filename_component(_HERE "${CMAKE_CURRENT_LIST_FILE}" DIRECTORY)
set(RPI_SYSROOT "${_HERE}/../root")
...
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)   # use host tools (moc, rcc, etc.)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)

# ── Qt6 location inside sysroot ───────────────────────────────────────────────
# Adjust the path below if your RPi OS puts Qt cmake files elsewhere.
# Check with: find ~/rpi5/root -name "Qt6Config.cmake" 2>/dev/null
